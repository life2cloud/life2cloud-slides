...
在这张Slide中，罗列了一些学习R语言的一些链接，里面有一些是其他人分享的他们在学习R语言时遇到的问题，希望你也可以从中获得一些提示，或者作为你开始系统学习R语言的第一部分阅读内容。
...
如果你想了解和学习最新发布的R包或者相关统计学方法，上一页Slide则远远不够了，你需要利用好互联网上所有可以获得的资源，并加以筛选和阅读。

这些资源主要包括以下几个类型：RSS聚合站点（如[R-Bloggers](https://www.r-bloggers.com)）、个人博客、论坛（如[Biostars](https://www.biostars.org/)、[ResarchGate](https://www.researchgate.net/)）、[GitHub Trend](https://github.com/explore)以及最前沿的期刊论文也会不断有新的R语言相关的学习资源，如绘图脚本、数据分析R包等（常见于[Bioinformatics](https://academic.oup.com/bioinformatics)、[BMC Bioinformatics](https://bmcbioinformatics.biomedcentral.com/)、[Nature Method](https://www.nature.com/nmeth/)、[Genome Biology](https://genomebiology.biomedcentral.com/)、[Genome Resarch](https://genome.cshlp.org/)、[Nucleic Acids Research](https://academic.oup.com/nar/)等）。

特别的，你可能需要特别关注一下[Rstudio](https://www.rstudio.com/)发布的一些[博客](https://blog.rstudio.com/)和学习资源，比如[视频](https://resources.rstudio.com/webinars)和[PPT](https://github.com/rstudio/rstudio-conf)，里面可能就包括了值得你学习的一些应用或者技巧。
...
动手的含义主要在于学习编程可能比其他技能更需要你的动手实践和尝试。如果你是初学者，切记不要直接复制粘贴示例代码而不做任何其他尝试。特别的，不要觉得自己运行完一遍代码了，就觉得自己学会了。
